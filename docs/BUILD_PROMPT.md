...
- Service: backend (build ./src/server, port 8080, depends_on graphrag)
- Service: frontend (build ./src/frontend, port 3000, depends_on backend)
...
Start with utils/, then pipelines/, then evaluation/, then src/server/, then src/frontend/.
