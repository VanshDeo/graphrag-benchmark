...
from src.graphrag.core.py_schemas import GenerateFunctionResponse, MapQuestionToSchemaResponse
...
class GenerateFunction(BaseTool):
    ...
    def _run(
        ...
        try:
            from src.graphrag.core.db.schema_utils import read_type_metadata
