...
from src.graphrag.core.config import embedding_dimension
    ...
    if "- embedding(Dimension=" in current_schema:
        ...
        if int(ver[0]) >= 4 and int(ver[1]) >= 2:
            ...
            supportai_queries.extend([
                "src/core/gsql/supportai/retrievers/Content_Similarity_Vector_Search.gsql",
                "src/core/gsql/supportai/retrievers/Chunk_Sibling_Vector_Search.gsql",
                "src/core/gsql/supportai/retrievers/GraphRAG_Community_Vector_Search.gsql",
                "src/core/gsql/supportai/retrievers/GraphRAG_Hybrid_Vector_Search.gsql",
            ])
        else:
